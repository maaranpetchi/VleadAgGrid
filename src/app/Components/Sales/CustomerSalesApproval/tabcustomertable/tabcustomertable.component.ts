...
export class TabcustomertableComponent implements OnInit {
  ...
  columnDefs: ColDef[] = [
    ...
    { headerName: 'Classification', field: 'description', filter: 'agTextColumnFilter',
      floatingFilter: true, },
    { headerName: 'EmailId', field: 'emailID', filter: 'agTextColumnFilter',
      floatingFilter: true, },
    { headerName: 'Phone Number', field: 'phoneNo', filter: 'agTextColumnFilter',
      floatingFilter: true, },
    { headerName: 'Phone Number', field: 'phone1', filter: 'agTextColumnFilter',
      floatingFilter: true, },
